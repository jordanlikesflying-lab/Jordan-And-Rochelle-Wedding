const CACHE='jrw-v1.0.1-final';
const SHELL=['/','/index.html','/command-center.html','/styles.css?v=1.0.1-final','/app.js?v=1.0.1-final','/icons/wedding-192.png','/icons/wedding-512.png'];
